...
LLM_MODEL = "ollama-deepseek-r1:1.5b" # 可选 ↓↓↓
AVAIL_LLM_MODELS = ["qwen-max", "o1-mini", "o1-mini-2024-09-12", "o1", "o1-2024-12-17", "o1-preview", "o1-preview-2024-09-12",
                    ...
                    "dashscope-deepseek-r1", "dashscope-deepseek-v3", "ollama-deepseek-r1:70b"
                    ]
...
# 插件分类默认选项
DEFAULT_FN_GROUPS = ['对话', '分析', '数据', '智能体']
